<template>
  <div style="display:flex;height:100vh" :class="isDark ? 'dark' : ''">
    ...
    >
      <div
        style="height:50px;display:flex;align-items:center;padding:0 16px;border-bottom:1px solid var(--sidebar-border, rgba(255,255,255,0.08));overflow:hidden"
      >
        <img src="@/assets/logo.svg" style="width:28px;height:28px;flex-shrink:0" />
        <span
          v-show="!collapsed"
          style="margin-left:12px;color:var(--sidebar-logo-text, #fff);font-size:16px;font-weight:600;white-space:nowrap"
          >Admin Pro</span
        >
      </div>
    ...
    <div style="flex:1;display:flex;flex-direction:column;overflow:hidden">
      <div
        style="height:50px;background:var(--navbar-bg,#fff);display:flex;align-items:center;justify-content:space-between;padding:0 16px;box-shadow:0 1px 4px rgba(0,0,0,0.08);flex-shrink:0"
      >
        ...
        <div>
          <el-dropdown trigger="click" :hide-on-click="false">
            <span
              style="display:flex;align-items:center;gap:6px;cursor:pointer;color:var(--text-regular,#606266);font-size:14px"
            >
              ...
              <el-dropdown-menu style="width:260px;padding:8px 0">
                ...
                <el-dropdown-item @click="toggleLang">
                  ...
                  >
                    ...
                    <span style="font-size:12px;font-weight:700;color:var(--el-color-primary)">{{
                      lang === 'zh-cn' ? 'EN' : '中'
                    }}</span>
                  </div>
                </el-dropdown-item>
      ...
      <div
        ...
        style="display:flex;align-items:center;height:36px;background:var(--navbar-bg,#fff);border-top:1px solid var(--border-light,#ebeef5);padding:0 8px;flex-shrink:0;gap:2px;overflow:hidden"
      >
        <!-- 购买横幅 -->
        <a
        ...
        >
          ...
          <span
            ...
            style="font-size:10px;line-height:1;border-radius:50%;width:14px;height:14px;display:inline-flex;align-items:center;justify-content:center"
            @click.stop="removeTag(tag.path)"
            >✕</span
          >
        </div>
        <span
          style="cursor:pointer;font-size:12px;color:var(--text-secondary,#909399);margin-left:4px;flex-shrink:0"
