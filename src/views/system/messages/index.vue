...
const messages = ref<Message[]>([
  {
    id: 1,
    title: '系统通知',
    content: '系统 V2.0 版本已成功上线，新增多项功能。',
    time: '10 分钟前',
    read: false,
    color: '#409eff',
    icon: Bell,
  },
  {
    id: 2,
    title: '安全警告',
    content: '检测到来自 IP 192.168.1.100 的异常登录尝试。',
    time: '30 分钟前',
    read: false,
    color: '#e6a23c',
    icon: Warning,
  },
  {
    id: 3,
    title: '任务完成',
    content: '数据备份任务已成功完成，共备份 12,580 条记录。',
    time: '1 小时前',
    read: false,
    color: '#67c23a',
    icon: CircleCheck,
