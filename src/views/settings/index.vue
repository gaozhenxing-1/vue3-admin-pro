      ...
      <el-tabs tab-position="left" style="min-height: 400px">
        <el-tab-pane :label="t('basicSettings')">
          <el-form label-width="120px" style="max-width: 500px">
            <el-form-item :label="t('siteName')">
              <el-input v-model="basic.siteName" />
            </el-form-item>
            <el-form-item :label="t('siteLogo')"><el-input v-model="basic.logo" /></el-form-item>
            <el-form-item :label="t('footerCopyright')">
              <el-input v-model="basic.copyright" />
            </el-form-item>
            <el-form-item>
        ...
        <el-tab-pane :label="t('themeSettings')">
          <el-form label-width="100px" style="max-width: 500px">
            ...
            <el-form-item :label="t('fixedHeader')">
              <el-switch v-model="theme.fixedHeader" />
            </el-form-item>
            <el-form-item :label="t('showTags')">
              <el-switch v-model="theme.showTags" />
            </el-form-item>
            <el-form-item>
              <el-button type="primary" @click="save">
                {{ t('saveSettings') }}
...
function save() {
  ElMessage.success(t('saveSettings'))
}
</script>
