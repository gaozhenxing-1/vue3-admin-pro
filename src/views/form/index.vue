    ...
    <el-card shadow="hover">
      ...
      <div v-else>
        <el-steps
          ...
          align-center
          style="max-width: 600px; margin: 0 auto 32px"
        >
        ...
        <div v-show="step === 2" style="max-width: 500px; margin: 0 auto">
          <el-descriptions :column="1" border>
            <el-descriptions-item :label="t('activityName')">
              {{ stepForm.name }}
            </el-descriptions-item>
            <el-descriptions-item :label="t('activityRegion')">
              {{ stepForm.region === 'shanghai' ? t('regionShanghai') : t('regionBeijing') }}
            </el-descriptions-item>
            <el-descriptions-item :label="t('instantDelivery')">
              {{ stepForm.delivery ? t('enabled') : t('disabled') }}
            </el-descriptions-item>
            <el-descriptions-item :label="t('activityType')">
              {{ stepForm.type.join(', ') }}
            </el-descriptions-item>
          </el-descriptions>
        </div>
        ...
        <div style="text-align: center; margin-top: 24px">
          ...
          <el-button v-if="step === 2" type="primary" @click="handleStepSubmit">
            {{ t('submit') }}
          </el-button>
        </div>
      </div>
